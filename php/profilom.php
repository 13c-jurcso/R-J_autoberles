...
<head>
    ...
    <title>Profilom - <?php echo htmlspecialchars($user['nev']); ?></title> <!-- Dinamikus cím -->
    ...
    <style>
        ...
        .tablazat table {
            margin-top: 20px;
            word-break: keep-all; /* Ne törje el a szavakat, ha lehet */
        }
        .tablazat th, .tablazat td {
             white-space: nowrap; /* Ne törje több sorba a cella tartalmát */
             vertical-align: middle; /* Vertikális középre igazítás */
        }
    </style>
</head>
<body>
